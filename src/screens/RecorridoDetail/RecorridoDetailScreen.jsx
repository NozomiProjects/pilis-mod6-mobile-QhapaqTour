    ...
    <ScrollView styles={styles.container}>
      ...
      {/* <View style={styles.detailsContainer}>
        <View style={styles.itemUser}>
          <Image source={{ uri: item.lugar.url }} style={styles.avatarUser} />
          <Text style={styles.fullname}>
            {item.nombre} {item.apellido}
          </Text>
        </View>
        <View styles={styles.itemRowContainer}>
            <MaterialCommunityIcons
              name="ticket-outline"
              size={24}
              color="black"
            />
          <Text styles={styles.itemInfo}>
            Cupos {item.cantidadPersonas}
          </Text>
        </View>
        <View styles={styles.itemRowContainer}>
          <Text styles={styles.itemInfo}>
            <MaterialCommunityIcons name="history" size={24} color="black" />
            Duración {formatDuration(item.duracion)}hs
          </Text>
        </View>
